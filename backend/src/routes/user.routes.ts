...
import { IdSchema, updateUserSchema, userSchema } from "../middlewares/validators/validators.js";
...
//update user profile
router.route("/:id").put(validate(IdSchema), validate(updateUserSchema), privateRoute, updateUser);
